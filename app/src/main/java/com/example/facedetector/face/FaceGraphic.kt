 ...
 */
class FaceGraphic constructor(overlay: GraphicOverlay?, private val face: Face, private val facePositionListener: (RectF) -> Unit) : GraphicOverlay.Graphic(overlay) {
