...
package com.example.facedetector.face
...
/** Face Detector Demo.  */
class FaceDetectorProcessor(context: Context, detectorOptions: FaceDetectorOptions?, val callback: (Boolean) -> Unit) :
  ...
  override fun onSuccess(faces: List<Face>, graphicOverlay: GraphicOverlay) {
    ...
    if (faces.isEmpty()) callback(false)
  }
